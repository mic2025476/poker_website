...
from . import views
from .views import check_availability, check_date_availability, create_booking, get_unavailable_slots, get_user_bookings, cancel_booking, reservation_settings, test_google_calendar, get_available_time_slots, get_available_durations, get_all_booking_data, get_unavailable_dates_range
...
urlpatterns = [
    ...
    path("reservation-settings/", reservation_settings, name="reservation_settings")
]